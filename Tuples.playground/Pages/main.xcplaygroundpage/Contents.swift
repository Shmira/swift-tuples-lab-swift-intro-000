...
var name:(name:String, age:Int) = ("John", 29)
...
print("\(name.name) is \(name.age) years old")
...
print("Happy \(name.age) birthday, \(name.name)!")
...
var someone:(name:String, age:Int) = ("Terry", 50)
...
let human:(name:String, age:Int) = ("Fred", 32)
